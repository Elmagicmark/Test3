...
class ProxyEngine {
    ...
    private fun processHttpTransaction(
        ...
        val hasInScopeRules = activeScopes.any { it.isInScope && it.isEnabled }
        val effectiveInScope = if (currentSettings.enforceScopeOnly || hasInScopeRules) inScope else true
